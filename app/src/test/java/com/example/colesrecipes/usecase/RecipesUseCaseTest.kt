...
class RecipesUseCaseTest {
    ...
    @Before
    fun setUp() {
        recipesUseCase = RecipesUseCase(repository)
    }
    ...
    fun `getRecipes returns all recipes from repository with formatted thumbnails`() = runTest {
        ...
        // When
        val result = recipesUseCase.getRecipes()
    ...
    fun `getRecipesWithinTime returns recipes from repository`() = runTest {
        ...
        // When
        val result = recipesUseCase.getRecipesWithinTime(40)
    ...
    fun `getRecipesWithinTime returns empty list when no recipes match`() = runTest {
        ...
        // When
        val result = recipesUseCase.getRecipesWithinTime(30)
